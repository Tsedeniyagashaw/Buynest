...
const { getAllUsers,getPendingSellers, approveSeller, getAllOrders, getAllProducts, getAdminStats,
 deleteProductAdmin, getAdminProfile, getAllSellers, toggleUserBlock, toggleProductStatus } = require("../controllers/adminController");
...
router.put("/products/:id/status", protect, authorizeRoles("admin"),toggleProductStatus);
