    ...
    <div className="fixed top-100 inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-lg p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block mb-1 text-sm font-medium">What would you like to report?</label>
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button type="submit" disabled={loading} className="px-5 py-2 rounded-lg bg-violet-700 text-white">
